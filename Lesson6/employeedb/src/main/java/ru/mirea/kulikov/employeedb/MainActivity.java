package ru.mirea.kulikov.employeedb;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void addInitialHeroes() {
        Hero[] heroes = {
                new Hero("Человек-паук", "Лазать по стенам, летать на паутине"),
                new Hero("Бэтмен", "Деньги, боевые искусства"),
                new Hero("Супермен", "Летает, суперсила")
        };
