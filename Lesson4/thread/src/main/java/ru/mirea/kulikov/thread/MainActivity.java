...
import ru.mirea.kulikov.thread.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainThread.setName(" \nМОЙ НОМЕР ГРУППЫ: БИСО-02-20, \nНОМЕР ПО СПИСКУ: 17, \nМОЙ ЛЮБИМЫЙ ФИЛЬМ: Trainspotting");
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Log.d("ThreadProject", String.format(
                                "Запущен поток № %d студентом группы БИСО-02-20, номер по списку 17", numberThread));
